...
export const OFFERS: Offer[] = [
  createOffer({
    ...
    currentPrice: 13.9,
    image: "/promotions/drafts/seda-creme-pentear.webp",
  ...
  createOffer({
    ...
    category: "cuidados_pessoais",
    currentPrice: 29,
    image: "/promotions/drafts/nivea-locao.webp",
    placeholderLabel: "Oferta aprovada",
    imageApproved: true,
    priceConfirmed: true,
    validityConfirmed: true,
  ...
  createOffer({
    ...
    currentPrice: 35,
    image: "/promotions/drafts/seda-boom.webp",
    placeholderLabel: "Oferta aprovada",
    imageApproved: true,
    priceConfirmed: true,
    validityConfirmed: true,
  ...
  createOffer({
    ...
    currentPrice: 55,
    image: "/promotions/drafts/sundown.webp",
    placeholderLabel: "Oferta aprovada",
    imageApproved: true,
    priceConfirmed: true,
    validityConfirmed: true,
  ...
  createOffer({
    ...
    category: "bebe",
    currentPrice: 44.9,
    image: "/promotions/drafts/hipopo.webp",
    placeholderLabel: "Oferta aprovada",
    imageApproved: true,
    priceConfirmed: true,
    validityConfirmed: true,
  ...
  createOffer({
    ...
    category: "bebe",
    currentPrice: 13.9,
    image: "/promotions/drafts/natural-baby-lenco.webp",
    placeholderLabel: "Oferta aprovada",
    imageApproved: true,
    priceConfirmed: true,
    validityConfirmed: true,
  ...
  createOffer({
    ...
    currentPrice: 49.9,
    image: "/promotions/drafts/comfort-master.webp",
    placeholderLabel: "Oferta aprovada",
    imageApproved: true,
    priceConfirmed: true,
    validityConfirmed: true,
  ...
  createOffer({
    ...
    category: "incontinencia",
    currentPrice: 16.9,
    image: "/promotions/drafts/salute.webp",
    placeholderLabel: "Oferta aprovada",
    imageApproved: true,
    priceConfirmed: true,
    validityConfirmed: true,
  ...
  createOffer({
    ...
    category: "bebe",
    currentPrice: 25,
    image: "/promotions/drafts/isababy.webp",
    placeholderLabel: "Oferta aprovada",
    imageApproved: true,
    priceConfirmed: true,
    validityConfirmed: true,
